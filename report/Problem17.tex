In this problem, the discrete time feedback is tested on the nonlinear model. The controller has been implemented on the SIMULINK model of the nonlinear system (see figure \ref{fig:modelp17}).
